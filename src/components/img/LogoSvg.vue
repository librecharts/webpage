<template>
  <svg width="100%" height="100%" viewBox="0 0 1000 1000" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;">
    <g transform="matrix(1.31398,0,0,1.18571,1.31926,0)">
        <rect x="-1.004" y="0" width="761.044" height="843.373" style="fill:rgb(8,20,33);"/>
    </g>
    <g transform="matrix(1.26228,0,0,1.26228,-131.139,-131.139)">
        <g id="map" transform="matrix(33.0091,0,0,33.0091,500,500)">
      ...
      <g id="flightsmode_FILL0_wght400_GRAD0_opsz48.svg" transform="matrix(8.2805,3.04306,-3.04306,8.2805,500,500)">
    ...
    <defs>
        <linearGradient id="_Linear1" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(64.9782,-64.5295,64.5295,64.9782,15.4729,32.2555)"><stop offset="0" style="stop-color:rgb(110,164,191);stop-opacity:1"/><stop offset="1" style="stop-color:white;stop-opacity:1"/></linearGradient>
    </defs>
</svg>
</template>